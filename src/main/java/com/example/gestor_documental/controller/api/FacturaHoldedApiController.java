...
public class FacturaHoldedApiController {
 ...
 @DeleteMapping("/{id}") @ResponseStatus(HttpStatus.NO_CONTENT) public void eliminar(@PathVariable Long id,Authentication auth){service.eliminar(id,currentUserService.requireAdmin(auth));}
