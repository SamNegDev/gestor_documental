...
public class JustificanteProvisionalService {
 ...
 private void validarTraspaso(Solicitud s){if(s.getTipoTramite()==null||s.getTipoTramite().getNombre()!=TipoTramiteEnum.TRASPASO)throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"El justificante provisional solo esta disponible para solicitudes de traspaso");}
