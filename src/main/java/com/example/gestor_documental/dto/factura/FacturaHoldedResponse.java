...
public record FacturaHoldedResponse(Long id, String numero, String contactoNombre, String contactoNif, LocalDate fechaEmision, LocalDate fechaVencimiento, BigDecimal total, BigDecimal importePagado, String moneda, EstadoFacturaHolded estado, LocalDateTime sincronizadaEn, int lineasPendientesRevision, String detalleLineasPendientes, boolean eliminable, List<ComprobantePagoResponse> comprobantes) {}
