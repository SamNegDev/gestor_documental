...
@NoArgsConstructor
@AllArgsConstructor
public class SolicitudLecturaIaJobResponse {
    ...
    public static SolicitudLecturaIaJobResponse from(SolicitudLecturaIaJob job) {
        if (job == null) return null;
        return SolicitudLecturaIaJobResponse.builder()
                .id(job.getId())
                .solicitudId(job.getSolicitud() != null ? job.getSolicitud().getId() : null)
    ...
    public static class Item {
        ...
        private static Item from(SolicitudLecturaIaItem item) {
            return Item.builder()
                    .id(item.getId())
