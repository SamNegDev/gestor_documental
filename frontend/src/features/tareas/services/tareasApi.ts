...
export const previsualizarAvisosSeleccionados = (incidenciaIds: number[]) => apiPostJson<AvisoSeleccionadoPreview>("/api/admin/resumen-diario-tramites/incidencias/seleccion/preview", { incidenciaIds });
