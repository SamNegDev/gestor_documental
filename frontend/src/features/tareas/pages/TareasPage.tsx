...
function taskIcon(tipo: string) {
  ...
  if (tipo === "WHATSAPP_PENDIENTE_REVISION" || tipo === "WHATSAPP_PENDIENTE_ASOCIAR" || tipo === "WHATSAPP_APORTACION_INDICADA" || tipo === "WHATSAPP_CONTACTO_SOLICITADO") return <MessageCircle size={19} />;
