...
export function SolicitudDetailPage() {
  ...
  const transferirDatosAExtension = (payload: ReturnType<typeof buildThempusPayload>) => new Promise<void>((resolve, reject) => {
    ...
    const timeout = window.setTimeout(() => {
      ...
      reject(new Error("No se detectó la extensión Thempus 0.3.1. Descárgala o recárgala en chrome://extensions."));
    }, 3000);
        ...
        {solicitud.tipoTramite === "TRASPASO" ? (<>
          <section className="record-observations provisional-proof" aria-label="Justificante provisional de gestoria">
            ...
            <div className="provisional-proof__actions">
              ...
              {isAdmin ? <a className="soft-button soft-button--compact" download href="/downloads/asistente-thempus-v0.3.1.zip"><Download size={15}/> Descargar asistente</a> : null}
          ...
          {isAdmin ? <details className="thempus-install-help">
            ...
            <p>Versión disponible: 0.3.1. Solo conecta esta aplicación con Thempus y nunca pulsa «ENVIAR».</p>
          </details> : null}
        </>) : null}
